...
class BaseStage extends FlxBasic
{
	...
	public function addBeforeGF(obj:FlxBasic) return insert(members.indexOf(game.gfGroup) + 1, obj);
	public function addBeforeBF(obj:FlxBasic) return insert(members.indexOf(game.boyfriendGroup) + 1, obj);
	public function addBeforeDad(obj:FlxBasic) return insert(members.indexOf(game.dadGroup) + 1, obj);
