...
class PauseSubState extends MusicBeatSubstate
{
	...
	public static var pauseBreakfastName:String = 'breakfast';

	public static var songName:String = null;

	public static function resetVariables()
	{
		pauseBreakfastName = 'breakfast';

		var _song = PlayState.SONG;
		if (_song != null)
		{
			if (_song.pauseBreakfast != null && _song.pauseBreakfast.trim().length > 0) pauseBreakfastName = _song.pauseBreakfast;
		}
	}
