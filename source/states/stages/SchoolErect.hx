...
class SchoolErect extends BaseStage
{
	override function create()
	{
		...
		{
			if (songName == 'roses' || songName == 'roses-erect')
			{
	...
	function schoolIntro():Void
	{
		...
		if (songName == 'senpai' || songName == 'senpai-erect')
		{
			add(black);
		}
	...
	/*override function addCharacter(character:String, charType:Int):Void
	{
		...
		switch (charType)
		{
			case 0:
				...
				rim.loadAltMask('weeb/erect/masks/bfPixel_mask.png');
				rim.maskThreshold = 1;
				rim.useAltMask = true;
			...
			case 2:
				...
				rim.loadAltMask('weeb/erect/masks/gfPixel_mask.png');
				rim.maskThreshold = 1;
				rim.useAltMask = true;
			...
			case 1:
				...
				rim.loadAltMask('weeb/erect/masks/senpai_mask.png');
				rim.maskThreshold = 1;
				rim.useAltMask = true;
