...
class Character extends FlxSprite
{
	...
	**/
	...
	public var useGridIcon:Bool = false;
	...
	public function loadCharacterFile(json:Dynamic)
	{
		...
		// data
		healthIcon = json.healthicon != null ? json.healthicon : (json.healthIcon != null ? json.healthIcon : '');
		useGridIcon = json.usegridicon != null ? json.usegridicon : (json.useGridIcon != null ? json.useGridIcon : false);
		//trace('[Character] healthIcon=' + healthIcon + ' useGridIcon=' + useGridIcon);
