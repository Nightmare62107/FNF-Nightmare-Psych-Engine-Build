	...
	public function new()
	{
		...
		*/
		...
		var option:Option = new Option('Scroll Type:',
			...
			'scrollType',
			STRING,
			["Upscroll", "Downscroll", "Middlescroll / Upscroll", "Middlescroll / Downscroll", "Leftscroll", "Rightscroll"]);
		addOption(option);
		...
		var option:Option = new Option('Disable Botplay Button',
			"If checked, pressing Botplay won't do anything mid-song.",
			'noBotplay',
			BOOL);
		addOption(option);
		...
		var option:Option = new Option('Miss Sounds',
			"If checked, Miss Sounds will play when you miss.",
			'missSounds',
			BOOL);
		addOption(option);
