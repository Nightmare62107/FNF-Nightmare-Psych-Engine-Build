...
// Event notes hooks
function onEvent(name:String, value1:String, value2:String, value3:String, value4:String, value5:String, strumTime:Float)
{
...
function onEventPushed(name:String, value1:String, value2:String, value3:String, value4:String, value5:String, strumTime:Float)
{
	// Called for every event note, recommended to precache assets
}

function eventEarlyTrigger(name:String, value1:String, value2:String, value3:String, value4:String, value5:String, strumTime:Float)
{
	/*
