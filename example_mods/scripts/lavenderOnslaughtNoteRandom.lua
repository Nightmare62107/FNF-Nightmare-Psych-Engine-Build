...
local replacementNoteType = 'Lavender Onslaught Note'
...
local lavenderOnslaughtNoteRandomEnabled = false
...
local function loadToggle()
    ...
    if lines[5] == "lavenderonslaughtnoterandom: true" then
        lavenderOnslaughtNoteRandomEnabled = true
    end
end
...
function onCreatePost()
    loadToggle()
	--debugPrint("Lavender Onslaught enabled = " .. tostring(lavenderOnslaughtNoteRandomEnabled))
    if not lavenderOnslaughtNoteRandomEnabled then return end
